...
where re.date_ev>=CURRENT_DATE-3  
--and re.type_pass=1 
and (re.areas_id =1 )
----
and re.staff_id=1804067
and ( (ip.ip_addr is Null)
/* or ( ip.ip_addr <>''10.18.1.38'' 
  and ip.ip_addr <>''10.18.1.139''
  and ip.ip_addr <>''10.18.1.140''
  and ip.ip_addr <>''10.18.1.69''
  and ip.ip_addr <>''10.10.130.110''
  and ip.ip_addr <>''10.0.130.110''
 )*/
 )
