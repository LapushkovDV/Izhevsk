...
* ----------------------------------------------------------------------------------------------- *
* Разработка  |#1159          |29/05/17|Евдокимов М.А.          |НПО Энергомаш                    *
\*************************************************************************************************/

.LinkForm 'GP_FormStsAllChangesXls' Prototype is 'FormStsAll'
.declare
#include GP_RepShrChanges.vih
#include GP_RepShrChangesParams.vih
#include GP_UserFilterStoreDSK.vih
.enddeclare
.NameInList 'ЭМ.Приложение к приказу. Изменение в штатном расписании ЭМ. Excel'
...
.begin
  ...
  //устанавливаем вид отчета - excel
  _store.SaveComp(1, 'ReportType');
